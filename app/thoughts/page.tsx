...
const articles = [
  { title: 'German translations exposed layouts I thought were flexible', date: '07/13', href: '/thoughts/german-translations-exposed-layouts-i-thought-were-flexible' },
