const articles: { title: string; date: string; href: string }[] = [
  { title: 'Empty states are where products show their character', date: '05/01', href: '/thoughts/empty-states-are-where-products-show-their-character' },
  { title: 'Color should be the last thing you decide', date: '04/26', href: '/thoughts/color-should-be-the-last-thing-you-decide' },
