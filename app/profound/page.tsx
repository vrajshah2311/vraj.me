    ...
    <main className="bg-white relative overflow-auto">
      <div className="flex justify-center">
        <div className="w-full max-w-[600px]">
          ...
          <h1 className="text-[18px] text-black mb-3" style={{ fontWeight: 500, fontVariationSettings: "'wght' 500" }}>Profound</h1>
          ...
          <div className="rounded-lg overflow-hidden border border-black/5">
            <img src="/profound.png" alt="Profound preview" className="w-full h-auto object-contain" />
          </div>
        </div>
      </div>
    </main>
