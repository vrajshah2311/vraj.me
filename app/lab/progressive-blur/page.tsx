...
export default function ProgressiveBlurPage() {
  ...
  useEffect(() => {
    ...
    if (!el) return
    const onScroll = () => { if (el.scrollTop > 8) setScrolled(true) }
    ...
    <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(145deg, #F0F1F4, #E8EAF0)', padding: '40px 24px' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Scrollable content */}
          <div ref={scrollRef} style={{ overflowY: 'auto', height: '100%', padding: '20px 20px 16px', scrollbarWidth: 'none' }}>
          ...
          <div style={{
            ...
            <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
              <path d="M5 2.5V7.5M5 7.5L2.5 5M5 7.5L7.5 5" stroke="rgba(10,10,10,0.35)" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
